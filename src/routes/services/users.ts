...
export default async (fastify: FastifyInstance, _options: any, done: any) => {
  ...
  fastify.get('/', {
    ...
    try {
      ...
      const data: any = await userModel.list(db, query, _limit, _offset);
  ...
  fastify.post('/', {
    ...
    try {
      ...
      const { username, password, firstName, lastName, enabled, role } = body;
